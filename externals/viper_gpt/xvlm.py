...
from viper_gpt.vit import VisionTransformer, interpolate_pos_embed
from viper_gpt.swin_transformer import SwinTransformer, interpolate_relative_pos_embed
from viper_gpt.xbert import BertConfig, BertForMaskedLM, BertModel
...
def build_text_encoder(config, vision_width, load_text_params=False, use_mlm_loss=False, config_text=None):
    ...
    config_text = BertConfig.from_json_file('../externals/viper_gpt/config_bert.json')
